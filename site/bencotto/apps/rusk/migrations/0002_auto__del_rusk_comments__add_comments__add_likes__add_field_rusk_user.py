...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('rusk', ['comments'])

        # Adding model 'likes'
        db.create_table('rusk_likes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('rusk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rusk.rusk'])),
        ))
        db.send_create_signal('rusk', ['likes'])

        # Adding field 'rusk.user'
        db.add_column('rusk_rusk', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], unique=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('rusk_comments')

        # Deleting model 'likes'
        db.delete_table('rusk_likes')

        # Deleting field 'rusk.user'
        db.delete_column('rusk_rusk', 'user_id')
