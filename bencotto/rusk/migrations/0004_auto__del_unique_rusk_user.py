...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'rusk', fields ['user']
        db.delete_unique('rusk_rusk', ['user_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'rusk', fields ['user']
        db.create_unique('rusk_rusk', ['user_id'])
